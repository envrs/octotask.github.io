...
For the best experience with octotask.diy, we recommend using the following models from our 19 supported providers:
...
octotask.diy uses a modular provider architecture. To add a new provider:
...
octotask.diy provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with octotask.diy?"
...
MCP extends octotask.diy's AI capabilities with external tools:
...
??? question "How do I deploy my octotask.diy projects?"
octotask.diy supports one-click deployment to multiple platforms:
...
octotask.diy provides comprehensive Git and GitHub integration:
...
??? question "What's new in octotask.diy?"
Recent major additions to octotask.diy include:
...
octotask.diy offers templates for popular frameworks and technologies:
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of octotask.diy
...
**Windows development environment**: Install Visual Studio C++ (version 14.40.33816 or later). More details in [GitHub Issues](https://github.com/stackblitz-labs/octotask.diy/issues/19)
