  ...
  ({ className, variant = 'default', hoverable = false, ...props }, ref) => {
    ...
    return (
      <CardContext.Provider value={{ variant }}>
        <div
          ref={ref}
          className={classNames('rounded-lg p-4 transition-theme', variantClasses[variant], hoverClasses, className)}
          {...props}
        />
...
const CardHeader = React.forwardRef<HTMLDivElement, CardHeaderProps>(({ className, ...props }, ref) => (
  <div ref={ref} className={classNames('pb-4 border-b border-gray-200 dark:border-gray-800', className)} {...props} />
));
...
const CardBody = React.forwardRef<HTMLDivElement, CardBodyProps>(({ className, ...props }, ref) => (
  <div ref={ref} className={classNames('py-4', className)} {...props} />
));
...
const CardTitle = React.forwardRef<HTMLHeadingElement, CardTitleProps>(({ className, ...props }, ref) => (
  <h2 ref={ref} className={classNames('text-lg font-semibold text-gray-900 dark:text-white', className)} {...props} />
));
...
const CardDescription = React.forwardRef<HTMLParagraphElement, CardDescriptionProps>(({ className, ...props }, ref) => (
  <p ref={ref} className={classNames('text-sm text-gray-600 dark:text-gray-400', className)} {...props} />
));
